...
public class ButtonMenu extends Menu
{
    ...
    private void initialize(RestAction<Message> ra)
    {
        ra.queue(m -> {
            for(int i=0; i<choices.size(); i++)
            {
                ...
                RestAction<Void> r = emote==null ? m.addReaction(Emoji.fromUnicode(choices.get(i))) : m.addReaction(emote);
                if(i+1<choices.size())
    ...
    public static class Builder extends Menu.Builder<Builder, ButtonMenu>
    {
         ...
         *
         * <p>Any non-unicode {@link net.dv8tion.jda.api.entities.emoji Emote} should be
        ...
        /**
         * Adds a single custom {@link net.dv8tion.jda.api.entities.emoji Emote} as button choices.
         *
         ...
         *
         * <p>Any non-unicode {@link net.dv8tion.jda.api.entities.emoji Emote}s should be
        ...
        /**
         * Adds custom {@link net.dv8tion.jda.api.entities.emoji Emote}s as button choices.
         *
         * <p>Any regular unicode emojis should be added using {@link
        ...
        /**
         * Sets the {@link net.dv8tion.jda.api.entities.emoji Emote}s as button choices.
         *
